...
data class SignInPasswordModel(
   ...
   * TODO Replace with dynamic value
   */
  var txtCAMPING010203: String? =
      MyApp.getInstance().resources.getString(R.string.lbl_camping010203)
  ,
  /**
   * TODO Replace with dynamic value
   */

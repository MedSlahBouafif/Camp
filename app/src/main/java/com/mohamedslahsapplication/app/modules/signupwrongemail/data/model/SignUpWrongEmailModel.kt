package com.mohamedslahsapplication.app.modules.signupwrongemail.`data`.model

import com.mohamedslahsapplication.app.R
import com.mohamedslahsapplication.app.appcomponents.di.MyApp
import kotlin.String

data class SignUpWrongEmailModel(
  /**
   ...
   * TODO Replace with dynamic value
   */
  var txtTheemailaddre: String? =
      MyApp.getInstance().resources.getString(R.string.msg_the_email_addre)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  var etGroupFortyNineValue: String? = null,
  /**
   * TODO Replace with dynamic value
   */
